...
Label(text = 'ROCK PAPER SCISSORS', font = font.Font(family="System",size = 45), bg = '#D2B48C').pack()
...
winner_label = Label(text = "Let's Start the Game...", fg = 'dark blue', bg = '#D2B48C', font = font.Font(size = 13, weight="bold"), pady = 8)
winner_label.pack()

input_frame = Frame(root, bg = '#D2B48C')
input_frame.pack()

                                                #Displaying player options
player_options = Label(input_frame, text = "Your Options : ", font = app_font, fg = 'black', bg = '#D2B48C')
...
score_label = Label(input_frame, text = 'Score : ', font = app_font, fg = 'black', bg = '#D2B48C')
score_label.grid(row = 2, column = 0)

player_choice_label = Label(input_frame, text = 'Your Selected : ---', font = app_font, bg = '#D2B48C')
player_choice_label.grid(row = 3, column = 1, pady = 5)

player_score_label = Label(input_frame, text = 'Your Score : 0', font = app_font, bg = '#D2B48C')
player_score_label.grid(row = 3, column = 2, pady = 5)

computer_choice_label = Label(input_frame, text = 'Computer Selected : ---', font = app_font, fg = 'black', bg = '#D2B48C')
computer_choice_label.grid(row = 4, column = 1, pady = 5)

computer_score_label = Label(input_frame, text = 'Computer Score : 0', font = app_font, fg = 'black', bg = '#D2B48C')
